...
SELECT SSN, Name AS 'This is SQL Exercise', 'Practice and Solution' FROM Scientists;

-- 2 Escreva uma query para exibir três números em três colunas.
SELECT * FROM Projects; 

-- 3 Escreva uma query para exibir a soma dos números 10 e 15.
SELECT CONCAT(10+15) AS Soma FROM Projects;

-- 4 Escreva uma query para exibir o resultado de uma expressão aritmética qualquer.
SELECT CONCAT(3 * 10 + 15 / 4) AS Soma FROM Projects;
...
SELECT * FROM Projects WHERE Hours ORDER BY Hours DESC LIMIT 3;
...
SELECT CONCAT('Existem ', COUNT(*), ' cientistas na tabela Scientists.') AS teste FROM Scientists;